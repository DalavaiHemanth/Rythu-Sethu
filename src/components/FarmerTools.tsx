...
import { getNPKAdvice, getWeatherDetails } from '../utils/agriHelpers';
...
export default function FarmerTools({ language }: FarmerToolsProps) {
  ...
  const [activeSubTab, setActiveSubTab] = useState<
    'npk' | 'shc' | 'mandi' | 'helpline' | 'weather'
  >('npk');
  ...
  const weather = getWeatherDetails(selectedWeatherDistrict, language);

  const advice = getNPKAdvice(crop, acres, season);
  ...
  const tl = {
    en: {
      ...
      subtitle:
        'PJTSAU validated agricultural tools, real-time Telangana mandi rates, and official helplines.',
      ...
      calculatedBags:
        'Recommended Fertilizer Quantities (standard bags of 45-50 Kg)',
      ...
      mandiDesc:
        'Typical Minimum Support Prices (MSP) compared with current trading ranges across major Telangana Agricultural Market Committees (AMCs) like Suryapet, Warangal, and Guntur.',
      cropName: 'Crop Name',
      ...
      helplineDesc:
        'Immediate direct assistance contacts for agricultural emergencies, seed distribution, or insurance policies.',
    },
    te: {
      title: 'రైతు స్మార్ట్ పరికరముల వేదిక',
      subtitle:
        'యూనివర్సిటీ ధృవీకరించిన ఎరువుల అంచనాలు, తాజా మండి మార్కెట్ ధరలు మరియు ప్రభుత్వ సహాయ సూచిక కార్డులు.',
      ...
      mandiDesc:
        'తెలంగాణలోని వరంగల్, సూర్యాపేట, ఖమ్మం వంటి ప్రధాన మార్కెట్లలో వివిధ పంటల కనీస మద్దతు ధర (MSP) మరియు ప్రస్తుత మార్కెట్ ట్రేడింగ్ ధరలు.',
      ...
      helplineDesc:
        'విత్తనాల సబ్సిడీ, పంట రుణాలు లేదా రైతు బీమా క్లెయిమ్ సమాచారం కొరకు వెంటనే సంప్రదించండి.',
    },
    ur: {
      title: 'کسان اسمارٹ یوٹیلیٹیز ہب',
      subtitle:
        'جامعہ کی تصدیق شدہ کھاد، تلنگانہ کی تازہ ترین منڈی کی قیمتیں، اور ہنگامی فون نمبرز',
      ...
      mandiDesc:
        'ورنگل، سوریا پیٹ اور کھمم مارکیٹوں میں فصلوں کے سرکاری نرخ اور موجودہ تجارتی منڈی کی قیمتیں۔',
      cropName: 'فصل کا نام',
      ...
      helplineDesc:
        'کسی بھی زرعی ہنگامی صورتحال، بیج سبسڈی یا انشورنس کے لیے فوری طور پر رابطہ کریں۔',
    },
  };
  ...
  const mandiData = [
    {
      name: currentTl.paddyFine,
      msp: '₹2,203',
      range: '₹2,350 - ₹2,580',
      status: currentTl.mktHigh,
      color: 'text-emerald-600 bg-emerald-50 border-emerald-200',
    },
    {
      name: currentTl.paddyCommon,
      msp: '₹2,183',
      range: '₹2,200 - ₹2,320',
      status: currentTl.mktSteady,
      color: 'text-blue-600 bg-blue-50 border-blue-200',
    },
    {
      name: currentTl.cottonLong,
      msp: '₹7,020',
      range: '₹7,200 - ₹7,850',
      status: currentTl.mktHigh,
      color: 'text-emerald-600 bg-emerald-50 border-emerald-200',
    ...
    {
      name: currentTl.redgram,
      msp: '₹7,000',
      range: '₹8,100 - ₹9,400',
      status: currentTl.mktHot,
      color: 'text-rose-600 bg-rose-50 border-rose-200',
    },
    {
      name: currentTl.maize,
      msp: '₹2,090',
      range: '₹2,150 - ₹2,300',
      status: currentTl.mktSteady,
      color: 'text-blue-600 bg-blue-50 border-blue-200',
  ...
  const helplines = [
    {
      title:
        language === 'te'
          ? 'రైతు సలహా ఫోన్ (వ్యవసాయ వర్సిటీ)'
          : language === 'ur'
            ? 'زرعی یونیورسٹی مشورہ فون'
            : 'PJTSAU Agri-University Advisors',
      number: '1800-425-3141',
      desc:
        language === 'te'
          ? 'క్రిమిసంహారకాల చల్లకం మరియు చీడపీడల నివారణ గురించి యూనివర్సిటీ శాస్త్రవేత్తలతో ఉచిత సంభాషణ.'
          : 'Connect directly with agricultural scientists to clarify soil health and pest control questions.',
      color: 'border-yellow-200 bg-yellow-50/40 text-yellow-905',
    },
    {
      title:
        language === 'te'
          ? 'రైతు బీమా జీవిత బీమా నివేదిక'
          : language === 'ur'
            ? 'ریتھو بیما انشورنس دعویٰ نمبر'
            : 'Rythu Bima Life Insurance Claims Assistance',
      number: '1800-599-1234',
      desc:
        language === 'te'
          ? 'భూయజమాని నామినీలకు క్లెయిమ్ దరఖాస్తులు మరియు మంజూరు వివరాల సహాయం.'
          : 'Liaison office handling fast paperless claim settlement for nominee families.',
      color: 'border-emerald-200 bg-emerald-50/40 text-emerald-905',
    },
    {
      title:
        language === 'te'
          ? 'సబ్సిడీ విత్తనాలు మరియు బ్యాంక్ రుణాలు'
          : language === 'ur'
            ? 'سبسڈی بیج اور فصل قرض معلومات'
            : 'Subsidized Seed & Crop Loan Inquiries',
      number: '1800-180-1551',
      desc:
        language === 'te'
          ? 'పట్టాదార్ పాస్ పుస్తకం ద్వారా విత్తన విక్రయాలు మరియు ఋణ అర్హత వివరాలు.'
          : 'Official credit line enquiries for certified inputs from state agricultural offices.',
      color: 'border-blue-200 bg-blue-50/40 text-blue-905',
    },
    {
      title:
        language === 'te'
          ? 'వ్యవసాయ విద్యుత్ శాఖ (TSSPDCL)'
          : language === 'ur'
            ? 'زرعی مفت بجلی شکایت نمبر'
            : '24/7 Quality Free Power Grid Grievance',
      number: '1912',
      desc:
        language === 'te'
          ? 'ఉచిత వ్యవసాయ విద్యుత్ సరఫరా వైఫల్యాలు లేదా ట్రాన్స్ఫార్మర్ల సమస్యలు.'
          : 'Immediate ticket submission regarding state 24-Hour free core agricultural power failures.',
  ...
  return (
    ...
    >
          ...
          <div className="md:col-span-5 bg-white rounded-xl p-5 border border-earth-100 text-left space-y-5">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                max={25}
                value={acres}
                onChange={(e) => setAcres(Number.parseInt(e.target.value) || 1)}
            ...
            <div className="bg-crop-900 text-white rounded-xl p-5 md:p-6 border border-crop-950 text-left">
              ...
              <div className="grid grid-cols-3 gap-3.5 mt-5">
                <div className="p-3 rounded-lg bg-crop-800 border border-crop-700/50 text-center">
                  ...
                  <p className="text-[10px] text-crop-220 font-bold uppercase mt-1 leading-tight">
                    {currentTl.urea}
                  </p>
                </div>
                <div className="p-3 rounded-lg bg-crop-800 border border-crop-700/50 text-center">
      ...
      {activeSubTab === 'shc' && <SoilHealthCard language={language} />}
            ...
            <table className="w-full text-xs text-stone-750 font-sans">
              <thead>
                <tr className="bg-stone-50 border-y border-stone-200 font-mono font-bold tracking-wider uppercase text-[10px] text-stone-500">
                  ...
                  <th className="py-2.5 px-4 text-center">
                    {currentTl.marketPrice}
                  </th>
                  <th className="py-2.5 px-4 text-right">
                    {currentTl.marketStatus}
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-stone-100 font-medium">
                {mandiData.map((row, idx) => (
                  <tr key={idx} className="hover:bg-stone-50/50">
                    ...
                    <td className="py-3 px-4 text-center font-mono font-bold text-stone-605">
                      {row.msp}
                    </td>
                    <td className="py-3 px-4 text-center font-mono font-black text-crop-800">
                      {row.range}
                    </td>
                    <td className="py-3 px-4 text-right">
                      <span
                        className={`px-2 py-0.5 rounded border text-[10px] font-bold ${row.color}`}
                      >
                        {row.status}
                      </span>
                    </td>
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
              <div>
                <h3 className="text-lg font-display font-medium text-crop-900 tracking-tight flex items-center gap-2">
                  ...
                  {language === 'te'
                    ? 'జిల్లా ముందస్తు వాతావరణ నివేదిక'
                    : language === 'ur'
                ...
                <p className={`text-xs text-stone-600 mt-0.5 ${pSpacingClass}`}>
                  {language === 'te'
                    ...
                    : language === 'ur'
                      ? 'تلنگانہ کے اضلاع کے لحاظ سے موسم اور اہم زرعی ہدایات۔'
                      : 'Micro-climate assessments and PJTSAU agro-advisories tailored to Telangana districts.'}
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-stone-600 mt-0.5 font-sans font-semibold">
                    {language === 'te'
                      ? 'తెలంగాణ స్మార్ట్ వాతావరణ అంచనా'
                      : language === 'ur'
                        ? 'تلنگانہ سمارٹ موسم کی پیش گوئی'
                        : 'Telangana Smart Forecast'}
                  </p>
                </div>
              </div>
              ...
              <div className="text-[11px] text-stone-500 font-mono mt-4 pt-3 border-t border-stone-200/30">
                {language === 'te'
                  ? 'తాజాకాల సమాచారం: 2026 మే'
                  : language === 'ur'
                    ? 'تازہ ترین اپ ڈیٹ: مئی 2026'
            ...
            <div className="md:col-span-8 bg-white p-6 rounded-xl border border-earth-100 text-left space-y-4 flex flex-col justify-between">
              <h4 className="text-xs font-mono font-bold text-crop-700 uppercase tracking-wider border-b border-stone-50 pb-2">
                📊{' '}
                {language === 'te'
                  ? 'వ్యవసాయ వాతావరణ సూచికలు'
                  : language === 'ur'
                    ? 'زرعی موسم کے اشارے'
                    : 'Agri-Meteorological Indicators'}
              </h4>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                ...
                <div className="bg-stone-50/60 p-3 rounded-lg border border-stone-150/40 space-y-2">
                  ...
                  <div className="text-[9px] text-stone-500 leading-normal">
                    {weather.humidity > 75
                      ? language === 'te'
                        ? 'కీటకాల వ్యాప్తికి అనుకూలం'
                        : language === 'ur'
                          ? 'کیڑوں کا خطرہ'
                          : 'Pest multiplication risk'
                      : language === 'te'
                        ? 'సాధారణ తేమ'
                        : language === 'ur'
                          ? 'معتدل نمی'
                ...
                <div className="bg-stone-50/60 p-3 rounded-lg border border-stone-150/40 space-y-2">
                  ...
                  <div className="text-[9px] text-stone-500 leading-normal">
                    {weather.soilMoisture < 25
                      ? language === 'te'
                        ? 'వెంటనే నీరు పెట్టాలి'
                        : language === 'ur'
                          ? 'پانی کی شدید ضرورت'
                ...
                <div className="bg-stone-50/60 p-3 rounded-lg border border-stone-150/40 space-y-2 col-span-2 sm:col-span-2">
                  ...
                  <div className="text-[9px] text-stone-500 leading-normal">
                    {weather.windSpeed > 15
                      ? language === 'te'
                        ? 'వేగవంతమైన గాలి - పిచికారీ తగదు'
                        : language === 'ur'
                          ? 'تیز ہوا - دوا ضائع ہوگی'
                          : 'High drift - postpone sprays'
                      : language === 'te'
                        ? 'పిచికారీకి అనుకూలం'
                        : language === 'ur'
                          ? 'سپرے کے لیے موضوع'
                          : 'Stable breeze - optimal spraying'}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white p-5 rounded-xl shadow-xs border border-earth-100 text-left space-y-4">
            <h4 className="text-sm font-display font-black text-rose-900 tracking-tight flex items-center gap-2 border-b border-rose-100 pb-2">
              <span className="p-1 rounded-full bg-rose-50 text-rose-600 animate-pulse">
                ⚠️
              </span>
              {language === 'te'
                ? 'వ్యవసాయ ముందస్తు జాగ్రత్తలు & అత్యవసర హెచ్చరికలు'
                : language === 'ur'
                  ? 'زرعی احتیاطی تدابیر اور انتباہات'
                  : 'Emergency Agricultural Weather Precautions'}
            </h4>
              ...
              {weather.rainProb > 45 && (
                <div className="p-4 rounded-lg bg-blue-50/70 border-l-4 border-blue-600 text-left space-y-2">
                  <h5 className="text-xs font-bold text-blue-900 flex items-center gap-1.5 uppercase font-sans">
                    🌧️{' '}
                    {language === 'te'
                      ? 'భారీ వర్షపాత ముందస్తు జాగ్రత్తలు'
                      : language === 'ur'
                        ? 'تیز بارش کی احتیاطی تدابیر'
                        : 'Heavy Rainfall Alert Precautions'}
                  </h5>
                  <div
                    className={`text-xs text-stone-800 ${language === 'te' ? 'leading-[1.95] tracking-[0.035em]' : 'leading-relaxed'} font-medium`}
                  >
                    {language === 'te' ? (
                      <div>
                      ...
                      <div>
                        • گندے پانی کی نکاسی کو یقینی بنائیں تاکہ جڑیں نہ گلیں۔
                        <br />• فصل کی کٹائی کو بارش کے رکنے تک موخر رکھیں۔
                        <br />• کسی بھی قسم کے اسپرے یا کھاد ڈالنا بند کر دیں۔
                      </div>
                    ) : (
                      <div>
                        • Clear crop drainage channels instantly to prevent
                        standing water and root rot.
                        <br />• Stop manual harvesting activities; safeguard
                        already cut stocks under waterproof sheets.
                        <br />• Postpone chemical sprays/fertilizers until
                        rainfall subsides.
                      </div>
                    )}
                  </div>
              ...
              {weather.temp > 35 && (
                <div className="p-4 rounded-lg bg-amber-50/70 border-l-4 border-amber-600 text-left space-y-2">
                  <h5 className="text-xs font-bold text-amber-950 flex items-center gap-1.5 uppercase font-sans">
                    🔥{' '}
                    {language === 'te'
                      ? 'అధిక వేడి & వడగాడ్పుల తీవ్రత కార్యాచరణ'
                      : language === 'ur'
                        ? 'لو اور تیز دھوپ کی احتیاطیں'
                        : 'Heatwave & Moisture Stress Precautions'}
                  </h5>
                  <div
                    className={`text-xs text-stone-850 ${language === 'te' ? 'leading-[1.95] tracking-[0.035em]' : 'leading-relaxed'} font-medium`}
                  >
                    {language === 'te' ? (
                      <div>
                      ...
                      <div>
                        • بخارات کے نقصان سے بچنے کے لیے شام یا صبح سویرے پانی
                        دیں۔
                        <br />• مٹی کی نمی برقرار رکھنے کے لیے گھاس پھوس کا
                        استعمال کریں۔
                        <br />• تیز گرمی کے دوران پودوں کے جھلسنے سے بچاؤ کے
                        اقدامات کریں۔
                      </div>
                    ) : (
                      <div>
                        • Apply supplementary irrigation strictly during late
                        evening/early morning to reduce evapotranspiration.
                        <br />• Employ organic crop residue mulch to preserve
                        subsurface soil moisture.
                        <br />• Keep continuous watch for signs of heat leaf
                        necrosis or temporary wilting.
                      </div>
                    )}
                  </div>
                </div>
              ...
              {weather.humidity > 70 && (
                <div className="p-4 rounded-lg bg-teal-50/70 border-l-4 border-teal-600 text-left space-y-2">
                  <h5 className="text-xs font-bold text-teal-900 flex items-center gap-1.5 uppercase font-sans">
                    🦠{' '}
                    {language === 'te'
                      ? 'కీటకాలు & దోమల నివారణ హెచ్చరిక'
                      : language === 'ur'
                        ? 'زیادہ نمی اور کیڑوں کا انتباہ'
                        : 'High Humidity & Pest Outbreak Warning'}
                  </h5>
                  <div
                    className={`text-xs text-stone-800 ${language === 'te' ? 'leading-[1.95] tracking-[0.035em]' : 'leading-relaxed'} font-medium`}
                  >
                    {language === 'te' ? (
                      ...
                      <div>
                        • زیادہ نمی کی وجہ سے پتے جھلسنے اور تنے کے گلنے کا خطرہ
                        رہتا ہے۔
                        <br />• پودوں کے پچھلے حصوں پر کیڑوں یا فنگس کی علامات
                        کا مسلسل معائنہ کریں۔
                        <br />• تحفظ کے لیے نیم کا تیل اور دیگر تجویز کردہ
                        دوائیں اسپرے کریں۔
                      </div>
                    ) : (
                      <div>
                        • Damp air conditions favor Rice Blast, Sheath Blight,
                        and stem borer propagation.
                        <br />• Spray 5% Neem seed kernel extract or recommended
                        bio-control agents as a baseline preventive.
                        <br />• Monitor visual under-leaf regions regularly for
                        early mycelial lesions or egg masses.
                      </div>
                    )}
                  </div>
                </div>
              ...
              {weather.windSpeed > 14 && (
                <div className="p-4 rounded-lg bg-stone-50/80 border-l-4 border-stone-600 text-left space-y-2">
                  <h5 className="text-xs font-bold text-stone-900 flex items-center gap-1.5 uppercase font-sans">
                    🌬️{' '}
                    {language === 'te'
                      ? 'ఈదురు గాలుల రక్షణ సలహాలు'
                      : language === 'ur'
                        ? 'تیز ہوا کے دوران احتیاطی اقدامات'
                        : 'High Wind Speed Protection Guidance'}
                  </h5>
                  <div
                    className={`text-xs text-stone-800 ${language === 'te' ? 'leading-[1.95] tracking-[0.035em]' : 'leading-relaxed'} font-medium`}
                  >
                    {language === 'te' ? (
                      ...
                      <div>
                        • تیز ہواؤں میں گنے یا بھٹے کے پودوں کو لکڑی کا سہارا
                        دیں۔
                        <br />• اسپرے مائع ضائع ہونے سے بچانے کے لیے تیز ہوا کے
                        وقت زرعی سپرے نہ کریں۔
                        <br />• خشک کھاد ڈالنے کو ہوا تھمنے تک عارضی طور پر موخر
                        رکھیں۔
                      </div>
                    ) : (
                      <div>
                        • Construct sturdy bamboo staking or side supports for
                        tall crops like sugarcane and maize.
                        <br />• Do not discharge high-pressure sprayer nozzles
                        to avoid drift loss.
                        <br />• Postpone top-dressing granular fertilizers until
                        regional winds become stable.
                      </div>
                    )}
                  </div>
                </div>
                ...
                weather.windSpeed <= 14 && (
                  <div className="p-4 rounded-lg bg-emerald-50/70 border-l-4 border-emerald-600 text-left space-y-2 col-span-full">
                    <h5 className="text-xs font-bold text-emerald-900 flex items-center gap-1.5 uppercase font-sans">
                      ✅{' '}
                      {language === 'te'
                        ? 'సాధారణ ప్రయోజనకర వ్యవసాయ సూచనలు'
                        : language === 'ur'
                          ? 'معتدل زرعی موسم کی گائیڈ'
                          : 'Optimal Weather Farming Guidance'}
                    </h5>
                    <div
                      className={`text-xs text-stone-800 ${language === 'te' ? 'leading-[1.95] tracking-[0.035em]' : 'leading-relaxed'} font-medium`}
                    >
                      {language === 'te' ? (
                        ...
                        <div>
                          • تمام عام زرعی سرگرمیوں، بشمول اسپرے اور کھاد کے لیے
                          بہترین دن ہے۔
                          <br />• آبپاشی کا باقاعدہ شیڈول برقرار رکھیں۔
                          <br />• جڑی بوٹیوں کو نکالنے اور کھیت کی صفائی کا کام
                          مکمل کریں۔
                        </div>
                      ) : (
                        <div>
                          • Excellent atmospheric windows today! Highly
                          favorable for general chemical application, sowing,
                          and tilling works.
                          <br />• Maintain standard 4-day structural crop
                          watering cycles.
                          <br />• Perform proactive field scouting to ensure
                          robust healthy leaf growth.
                        </div>
                      )}
                    </div>
                  </div>
          ...
          <div className="space-y-3 text-left">
            <h4 className="text-xs font-mono font-bold text-stone-700 uppercase tracking-widest pl-1">
              📅{' '}
              {language === 'te'
                ? 'రాబోవు 3 రోజుల వివరాలు'
                : language === 'ur'
                  ? 'آئندہ 3 دنوں کا موسم'
                  : '3-Day Agricultural Trend Outlook'}
            </h4>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {weather.forecast.map((dayItem, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <span className="text-xl">{dayItem.icon}</span>
